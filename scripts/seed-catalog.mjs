...
const CURATED_SOURCES = [
  ...
  },
  {
    ...
    name: "NASA EONET",
    category: "Natural events",
    description: "Open natural events — wildfires, storms, volcanoes, and more.",
    baseUrl: "https://eonet.gsfc.nasa.gov",
    docsUrl: "https://eonet.gsfc.nasa.gov/docs/v3",
    auth: "none",
    exampleEndpoint: "https://eonet.gsfc.nasa.gov/api/v3/events?status=open&limit=10",
    sampleFields: ["title", "categories", "geometry", "sources"],
    tags: ["science", "maps", "alerts"],
  },
  {
    id: "city-bikes",
    name: "CityBikes",
...
function applySourceFixes(sources) {
  const fixes = {
    ...
    "nasa-apod": {
      name: "NASA Images",
      exampleEndpoint: "https://images-api.nasa.gov/search?q=nebula&media_type=image&page_size=10",
      baseUrl: "https://images-api.nasa.gov",
      docsUrl: "https://images.nasa.gov/docs/images.nasa.gov_api_docs.pdf",
      auth: "none",
      description: "NASA image and video library — searchable space photos with titles and metadata.",
      sampleFields: ["title", "nasa_id", "description", "keywords", "links"],
    },
    "nasa-media-library": {
      exampleEndpoint: "https://images-api.nasa.gov/search?q=nebula&media_type=image&page_size=10",
      baseUrl: "https://images-api.nasa.gov",
    ...
    "nasa-neows": {
      name: "NASA EPIC",
      exampleEndpoint: "https://api.epic.gsfc.nasa.gov/api/natural/date/2024-06-15",
      baseUrl: "https://api.epic.gsfc.nasa.gov",
      docsUrl: "https://epic.gsfc.nasa.gov/about/api",
      auth: "none",
      description: "Earth imagery from the DSCOVR satellite — multiple views per date.",
      sampleFields: ["caption", "date", "image", "coords"],
    },
    "nasa-epic": {
      exampleEndpoint: "https://api.epic.gsfc.nasa.gov/api/natural/date/2024-06-15",
      baseUrl: "https://api.epic.gsfc.nasa.gov",
